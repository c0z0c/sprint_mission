...
# 싱글톤 인스턴스
_sentiment_predictor_instance = None


def get_sentiment_predictor() -> "SentimentPredictor":
    """
    SentimentPredictor 싱글톤 인스턴스 반환

    Returns:
        SentimentPredictor: 싱글톤 인스턴스
    """
    global _sentiment_predictor_instance
    if _sentiment_predictor_instance is None:
        _sentiment_predictor_instance = SentimentPredictor()
    return _sentiment_predictor_instance
