...
from app.ai.SentimentPredictor import get_sentiment_predictor
...
class ReviewService:
    ...
    def delete_review(self, review_id: int) -> bool:
        ...
        logger.debug(f"[Service] Review deleted for TMDB ID: {tmdb_id}")
    ...
    def get_movie_rating(self, tmdb_id: int) -> dict:
        ...
        ai_rating = positive_ratio * 10.0  # 10점 만점
