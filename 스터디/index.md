...
{% assign completed_files = site.static_files | where_exp: "file", "file.path contains '스터디/'" %}
...
{% assign working_files = site.static_files | where_exp: "file", "file.path contains '스터디/'" %}
...
<div class="progress-overview">
  <div class="progress-card">
    ...
    <div class="progress-label">스터디</div>
